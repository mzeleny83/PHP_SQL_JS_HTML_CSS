...
- `id` INT
- `image` (INT) - id obrázku z tabulky obrázky
- `nadpis` varchar(90)
- `popis` text
...
Stránka bude obsahovat obrázek příspěvku (rozumné velikosti, na střed). Pod ním bude datum vytvoření, nadpis a samotný popis (neboli obsaho příspěvku). Dále bude stránka obsahovat také komponenty hlavičku a patičku.
